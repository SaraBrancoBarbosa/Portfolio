...
function Projects() {
  return (
    <div className="flex flex-col gap-5 lg:gap-10 w-full">
      ...
      <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-3 lg:gap-10 p-3 sm:p-10 justify-center items-center rounded-2xl bg-violet-100 sm:min-h-104">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 mb-5 lg:mb-10 gap-3 lg:gap-10 p-3 sm:p-10 justify-center items-center rounded-2xl bg-violet-100 sm:min-h-104">
        <div className="flex flex-col items-center">
